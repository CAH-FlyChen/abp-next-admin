...
namespace LY.MicroService.Applications.Single.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240828025519_2024082803")]
    partial class _2024082803
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("App_Product_Brands", null, t =>
                        {
                            t.HasComment("产品品牌");
                        });
                });
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.SpecificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("SpecificationTemplate");

                    b.HasDiscriminator<string>("Discriminator").HasValue("SpecificationTemplate");
            ...
            modelBuilder.Entity("Zion.Sales.SalesContext.ShoppingCart", b =>
                {
                    ...
                    b.ToTable("SalesShoppingCarts", (string)null);
                });
            ...
            modelBuilder.Entity("Zion.Sales.SalesContext.ShoppingCartItem", b =>
                {
                    ...
                    b.ToTable("SalesShoppingCartItems", (string)null);
                });

            modelBuilder.Entity("Zion.System.AdContext.Ad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("App_System_Ads", null, t =>
                        {
                            t.HasComment("广告");
                        });
                });
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.CategorySpecTemplate", b =>
                {
                    b.HasBaseType("Zion.Product.ProductContext.SpecificationTemplate");
                    ...
                    b.HasDiscriminator().HasValue("CategorySpecTemplate");
                });

            modelBuilder.Entity("Zion.Product.ProductContext.ProductSpecTemplate", b =>
                {
                    b.HasBaseType("Zion.Product.ProductContext.SpecificationTemplate");
                    ...
                    b.HasDiscriminator().HasValue("ProductSpecTemplate");
                });
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.Category", b =>
                {
                    b.HasOne("Zion.Product.ProductContext.Category", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.SpecificationTemplate", b =>
                {
                    b.OwnsMany("Zion.Product.ProductContext.SpecificationGroup", "SpecGroups", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");

                            b1.Property<Guid>("CategorySpecTemplateId")
                                .HasColumnType("char(36)");
                            ...
                            b1.HasIndex("CategorySpecTemplateId");

                            b1.ToTable("SpecificationGroup");

                            b1.WithOwner()
                                .HasForeignKey("CategorySpecTemplateId");

                            b1.OwnsMany("Zion.Product.ProductContext.SpecificationGroupItem", "Specifications", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("char(36)");
                                    ...
                                    b2.Property<Guid>("SpecificationGroupId")
                                        .HasColumnType("char(36)");
                                    ...
                                    b2.HasIndex("SpecificationGroupId");

                                    b2.ToTable("SpecificationGroupItem");
            ...
            modelBuilder.Entity("Zion.Product.ProductContext.CategorySpecTemplate", b =>
                {
                    b.HasOne("Zion.Product.ProductContext.Category", null)
                        .WithOne("SpecTemplate")
                        .HasForeignKey("Zion.Product.ProductContext.CategorySpecTemplate", "CategoryId");
                });

            modelBuilder.Entity("Zion.Product.ProductContext.ProductSpecTemplate", b =>
                {
                    b.HasOne("Zion.Product.ProductContext.Product", null)
                        .WithOne("SpecTemplate")
                        .HasForeignKey("Zion.Product.ProductContext.ProductSpecTemplate", "ProductId");
                });
