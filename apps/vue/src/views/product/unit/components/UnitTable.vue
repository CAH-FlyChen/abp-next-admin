...
<template>
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        <a-button v-auth="['Product.Unit.Create']" type="primary" @click="handleAddNew">{{
          L('AddNew')
        }}</a-button>
      </template>
    ...
    <UnitDrawer @register="registerDrawer" @change="handleChange" :framework="useFramework" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  // 自有组件  
  import { getDataColumns } from './UnitData';
  import { getSearchFormSchemas } from './ModalData';
  import { getList, getById, deleteById } from '/@/api/product/unit';
