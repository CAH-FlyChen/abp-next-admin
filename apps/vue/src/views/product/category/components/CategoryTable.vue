...
<template>
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        <a-button v-auth="['Product.Category.Create']" type="primary" @click="handleAddNew">{{
          L('AddNew')
        }}</a-button>
      </template>
    ...
    <CategoryDrawer @register="registerDrawer" @change="handleChange" :framework="useFramework" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  // 自有组件  
  import { getDataColumns } from './CategoryData';
  import { getSearchFormSchemas } from './ModalData';
  import { getList, getById, deleteById } from '/@/api/product/category';
  ...
  function handleAddNew(record?: Recordable) {
    openDrawer(true, {parentId:record.id});
  }
