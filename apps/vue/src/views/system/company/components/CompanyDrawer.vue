...
<script lang="ts" setup>
  ...
  import { useCompanyFormContext } from '../hooks/useCompanyFormContext';
  ...
  const entity = ref<Company>({} as Company);
  const framework = ref<string | undefined>('');
  const formElRef = ref<Nullable<TabFormActionType>>(null);

  const { formTitle, getFormSchemas, handleFormSubmit /*,fetchCompanyResource*/ } = useCompanyFormContext({
    companyModel: entity,
    formElRef: formElRef,
  });
